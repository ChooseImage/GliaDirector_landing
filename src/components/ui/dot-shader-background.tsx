...
const DotMaterial = shaderMaterial(
  ...
  /* glsl */ `
    ...
    void main() {
      ...
      float baseDot = sdfCircle(gridUv, 0.05);

      // Screen mask
      float screenMask = smoothstep(0.0, 1.0, uv.y); // 1 at the top, 0 at the bottom
      screenMask = mix(0.0, 1.0, screenMask);

      vec2 centerDisplace = vec2(0.7, -0.1);
      ...
      float opacityInfluence = max(mouseInfluence *2.0, circleAnimatedMask * 0.01);
